 ...
 *
 * $Horde: horde/lib/Test.php,v 1.21 2004/02/14 02:40:35 chuck Exp $
 *
    ...
    function configFilesMissing($app, $appBase, $files, $additional = array())
    {
        ...
        $descriptions = array_merge(array(
            'conf.php' => sprintf('This is the main %s configuration file. ' .
                                  ...
                                  'Configuration".',
                                  $app, $app, $appBase . DIRECTORY_SEPARATOR . 'config'),
        ...
        $footer = sprintf('Create these files from their .dist versions in %s and change them according to your needs.', $appBase . DIRECTORY_SEPARATOR . 'config');
