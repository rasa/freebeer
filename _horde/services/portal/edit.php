<?php
/**
 * $Horde: horde/services/portal/edit.php,v 1.38 2004/02/14 01:36:27 chuck Exp $
 *
...
require_once HORDE_LIBS . 'Horde/Block/Collection.php';
require_once HORDE_LIBS . 'Horde/Block/Layout.php';
