<?php
/**
 * $Horde: horde/services/portal/menu.php,v 2.77 2004/02/22 02:49:30 chuck Exp $
 *
...
if (Auth::isAdmin()) {
    ...
    $link = Horde::link(Horde::applicationUrl('admin/setup/'), _("Configuration"), 'menuitem sidebaritem', $target, null, _("Configuration"));
    $menutext .= '</td><td width="28" align="center">' . $link . Horde::img('config.gif', _("Configuration")) . '</a></td><td>' . $link . _("Configuration") . '</a></td></tr>';
