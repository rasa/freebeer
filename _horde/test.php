<?php
/**
 * $Horde: horde/test.php,v 1.116 2004/02/05 17:38:00 slusarz Exp $
 *
...
$module_list = array(
    ...
    'zlib'       => array(
        ...
        'error'   => 'The zlib module is highly reccomended for use with Horde.  It allows page compression and handling of ZIP and GZ data. Compile PHP with <code>--with-zlib</code> to activate.',
        'fatal'   => false
    ),
);
