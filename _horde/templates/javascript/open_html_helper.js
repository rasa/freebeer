 ...
 *
 * $Horde: horde/templates/javascript/open_html_helper.js,v 1.6 2004/01/19 04:52:50 mdjukic Exp $
 *
...
function openHtmlHelper(type, target)
{
    ...
    if (type == 'emoticons') {
        ...
        <?php require_once HORDE_LIBS . 'Horde/Text/Filter/emoticons.php'; $patterns = Text_Filter_emoticons::getPatterns(); $icons = array_flip($patterns['replace']); foreach ($icons as $icon => $string): ?>
