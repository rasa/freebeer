...
Source: http://www.ohdave.com/rsa/BigInt.js
...
{
	var result = new BigInt("");
	arrayCopy(x.digits, n, result.digits, 0, maxDigits - n);
	return result;
}
...
function biPow(x, y)
{
	var result = biFromArray(bigOne.digits);
	var a = biFromArray(x.digits);
	a.isNeg = x.isNeg;
	while (true) {
