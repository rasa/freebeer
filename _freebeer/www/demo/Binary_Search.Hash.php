...
// $CVSHeader: _freebeer/www/demo/Binary_Search.Hash.php,v 1.1.1.1 2004/01/18 00:12:07 ross Exp $
...
echo html_header_demo('fbBinarySearch_Hash Class (Binary Search a Hash)');
...
?>
<form method="post" name='frm_binary_search_hash'>
<table>
...
for ($i = 0; $i < $attempts; ++$i) {
	...
	$rv = fbBinarySearch_Hash::search($search_term, $a, false);
